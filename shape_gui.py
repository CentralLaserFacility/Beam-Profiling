...
class SetupFrame(wx.Frame):
    ...
    def __do_layout(self):
        ...
        sizer_2.Add(self.trace_preview_button, 1, wx.ALIGN_CENTER_VERTICAL | wx.EXPAND, 0)
        ...
        sizer_1.Add(scope_slice_sizer, 2, wx.ALIGN_CENTER_VERTICAL, 0)
        sizer_3.Add((20, 20), 0, 0, 0)
        sizer_3.Add(self.target_source_radio_box, 1, wx.ALIGN_CENTER | wx.EXPAND, 0)
        sizer_3.Add((20, 20), 0, 0, 0)
